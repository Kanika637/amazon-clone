    ...
    <div className="login">
      <Link to="/">
        <img
          ...
          src="https://th.bing.com/th/id/OIP.Ku4iy6JfyZOZAKxOkfp0ewHaEK?pid=ImgDet&rs=1"
          alt="Login"
        />
      </Link>
      <div className="login__container">
        ...
        <form>
          <h5 className="credential_name" id="mailText">
            Email
          </h5>
          <h5
            className="credential_name"
            id="pswdText"
            style={{ display: 'none' }}
          >
            Password
          ...
          <input
            ...
            className="input_box"
          />
          <button id="Continuebutton" onClick={changePage}>
            Continue
          </button>
          <button
            className="loginsign_button"
            id="signInbutton"
            type="submit"
            onClick={signIn}
            style={{ display: 'none' }}
        ...
        <p className="login_info">
          ...
          <a href={anchLink}> Conditions of Use </a>and{' '}
          <Link to="/">Privacy Notice</Link>.<br></br>
          <br></br>
