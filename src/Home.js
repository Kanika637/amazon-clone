    ...
    <>
      <div className="home">
        <div className="home__container">
          ...
          <div className={`home__row ${show ? "hide" : "show"}`}>
          ...
          <div className={`home__row ${show ? "hide" : "show"}`}>
            <Product title="VERO MODA Women's Regular Fit T-Shirt"
              price={196.42}
              image="https://m.media-amazon.com/images/I/71oX2cE7t-L._UY879_.jpg"
              rating={4}
              reviews={18} />
            <Product title="WORLD WEAR FOOTWEAR Men's Sport Sneakers Shoes"
              price={299}
              image="https://m.media-amazon.com/images/I/81S1E1Dr-BL._AC_UL480_QL65_.jpg"
              rating={3}
              reviews={131} />
            <Product title="THUTHO ENTERPRISE Stainless Steel Smart Vacuum"
              price={399}
              image="https://m.media-amazon.com/images/I/51IxM8ERzvL._AC_UL480_FMwebp_QL65_.jpg"
              rating={1}
              reviews={1} />
          </div>
          <div className={`home__row ${show ? "hide" : "show"}`}>
            <Product title="Samsung Galaxy M33 5G (Mystique Green, 8GB, 128GB Storage)"
              price={16999}
              image="https://m.media-amazon.com/images/I/81I3w4J6yjL._SX522_.jpg"
              rating={4}
              reviews={14591}/>
            <Product title="HP v236w USB 2.0 64GB Pen Drive, Metal"
              price={429}
              image="https://m.media-amazon.com/images/I/61xNG4wjOuL._SY450_.jpg"
              rating={4}
              reviews={58125}/>
            <Product title="TCL 126 cm (50 inches) 4K Ultra HD Certified Android Smart LED TV 50P615 (Black)"
              price={27990}
      ...
      <div className='btn-container'>
        <button onClick={loadMore} className="load-more-btn">{`${show ? "Show More" : "Show Less"}`}</button>
      </div>
    </>
  )
}
