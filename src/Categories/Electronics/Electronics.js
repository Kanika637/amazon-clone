  ...
  return (
    <>
      ...
      <div className="home__row">
        <Product title="boAt Airdopes 121v2 True Wireless Earbuds with Upto 14 Hours Playback, 8MM Drivers, Battery Indicators,"
          price={999}
          image="https://m.media-amazon.com/images/I/510+wjzq-vL._AC_UL480_QL65_.jpg"
          rating={4}
          reviews={155214} />

        <Product title="Fire-Boltt, Noise, Boat & more"
          price={999}
          image="https://m.media-amazon.com/images/I/41qqmdUWnhL._AC_UF226,226_FMjpg_.jpg"
          rating={4}
          reviews={1648} />

        <Product title="Redgear A-15 Wired Gaming Mouse with"
          price={389}
      ...
      <div className="home__row">
        <Product title="Callas Multipurpose Foldable Laptop Table with Cup Holder | Drawer | Mac Holder | Table Holder Study Table, "
          price={1350}
          image="https://m.media-amazon.com/images/I/61GQUtqKIpS._SX355_.jpg"
          rating={5}
          reviews={18663} />

        <Product title="HD FD236W 32GB"
          price={328}
          image="https://images-eu.ssl-images-amazon.com/images/I/61aflcZgumL._AC._SR360,460.jpg"
          rating={4}
          reviews={57344} />

        <Product title="SanDisk Ultra microSD UHS-I Card 64GB"
          price={599}
      ...
      <div className="home__row">
        <Product title="1.9' Inch Screen|Amoled Smartwatche"
          price={4999}
          image="https://m.media-amazon.com/images/I/41LW7In+1OL._AC_UF226,226_FMjpg_.jpg"
          rating={4}
          reviews={2408} />

        <Product title="Trendy Bands and straps for your Smartwatch"
          price={359}
          image="https://m.media-amazon.com/images/I/41bh654uCTL._AC_UF226,226_FMjpg_.jpg"
          rating={4}
          reviews={1360} />

        <Product title="boAt Immortal IM1000D Dual Channel Wired O"
          price={1874}
      ...
      <div className="home__row">
        <Product title="Wacom One by CTL-472/K0-CX Digital Drawing Graphics Pen Tablet (Red & Black) Small (6-inch x 3.5-inch)(15x8cm)"
          price={2890}
